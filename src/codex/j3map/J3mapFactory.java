...
public class J3mapFactory implements AssetLoader {
    ...
    /**
     * Returns true if the provided class type is supported by J3map. Includes custom processors.
     *
     * @param classtype
     * @return
     */
    ...
    /**
     * Get the first custom processor which matches the class type. Returns null if no processor which matches
     * is found.
     *
     * @param classtype
     * @return
    ...
    /**
     * Reads the asserted <code>InputStream</code> and applies it to the asserted j3map. This is the main
     * method used for reading a j3map file.
     *
     * @param map
     * @param stream
    ...
    /**
     * Returns a boolean array of length 2 representing comment state. The first element indicates if the
     * input string is inside a comment. The second element indicates if the comment continues to the next
     * line.
     *
